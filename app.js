...
// Second WebSocket server on port 8086
var wsServer2 = new (ws.Server)({ port: 8086 });
wsServer2.on('connection', function(socket) {
  console.log('New WebSocket Connection on 2nd WebSocket server (' + wsServer2.clients.length + ' total)');
